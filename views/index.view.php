                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Our Location</h4>
                                <p class="m-0">University Village Plot 91, Cadastral Zone Nnamdi Azikiwe Expressway Jabi, Abuja Nigeria.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                            <div class="btn-icon bg-secondary mr-4">
                            ...
                            <div class="mt-n1">
                                <h4>Call Us</h4>
                                <p class="m-0">+234 813 351 5393</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <p class="m-0">info@timetable.com</p>
                            </div>
                        </div>
                    </div>
                </div>
